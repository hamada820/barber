...
<main id="main" class="main">
  <div class="pagetitle d-flex justify-content-between align-items-center">
    ...
    <a href="<?= base_url('kasir/riwayat') ?>" class="btn btn-secondary btn-sm">
          ...
          <tbody>
            ...
            foreach ($riwayat as $row): ?>
              <tr>
                ...
                <td>
                  <a href="<?= base_url('kasir/deleteRiwayat/' . $row['id_history']) ?>" onclick="return confirm('Yakin ingin menghapus data ini?')" class="btn btn-danger btn-sm mb-1">Hapus</a>
          ...
          <div class="modal fade" id="editModal<?= $row['id_history'] ?>" tabindex="-1" aria-labelledby="editModalLabel<?= $row['id_history'] ?>" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                <form action="<?= base_url('kasir/updateRiwayat/' . $row['id_history']) ?>" method="post" enctype="multipart/form-data">
